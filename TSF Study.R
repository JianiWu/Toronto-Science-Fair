...
#Train a Random Forest with the parameters as Numbers, Letters, & Control
RfTrain7 <- Study[c("Numbers", "Letters", "Control")]
set.seed(1)
#Generate the Random Forest
Rf7 <- randomForest(x = RfTrain7, y = RfLabel, importance = TRUE, ntree = 1000)
Rf7
#Results: OOB estimate of error rate: 15.38%
...
#Accuracy = 0.7867460 for k = 12, times = 10